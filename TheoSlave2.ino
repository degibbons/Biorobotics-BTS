...
int FLstance1[21] = {1590, 1755, 1869, 1941, 1982, 1999, 2002, 1995, 1985, 1976, 1971, 1974, 1985, 2004, 2032, 2066, 2104, 2143, 2176, 2199, 2205};
int FLstance2[21] = {1996, 1998, 2008, 2022, 2037, 2049, 2058, 2060, 2056, 2043, 2023, 1996, 1963, 1926, 1887, 1849, 1816, 1791, 1779, 1785, 1816};
int FLstance3[21] = {2306, 2371, 2414, 2441, 2453, 2454, 2447, 2432, 2412, 2387, 2357, 2323, 2284, 2239, 2186, 2124, 2050, 1960, 1852, 1721, 1564};
int FLstance4[21] = {2305, 2098, 1973, 1908, 1886, 1889, 1903, 1918, 1925, 1919, 1895, 1855, 1798, 1731, 1661, 1597, 1552, 1542, 1583, 1697, 1906};

int HLstance1[21] = {1434, 1457, 1483, 1513, 1550, 1593, 1645, 1704, 1772, 1846, 1926, 2010, 2097, 2183, 2267, 2344, 2411, 2463, 2497, 2506, 2485};
int HLstance2[21] = {2314, 2258, 2217, 2186, 2166, 2152, 2144, 2139, 2137, 2135, 2133, 2130, 2126, 2120, 2111, 2100, 2088, 2074, 2060, 2046, 2034};
int HLstance3[21] = {2116, 2035, 1974, 1926, 1889, 1857, 1828, 1799, 1769, 1736, 1702, 1665, 1628, 1593, 1562, 1540, 1529, 1536, 1566, 1626, 1723};
int HLstance4[21] = {2671, 2631, 2559, 2466, 2362, 2256, 2153, 2061, 1983, 1924, 1885, 1869, 1876, 1903, 1951, 2014, 2089, 2171, 2252, 2325, 2380};

int FLswing1[21] = {2175, 2205, 2237, 2269, 2295, 2312, 2319, 2315, 2297, 2266, 2222, 2167, 2102, 2030, 1955, 1880, 1810, 1751, 1709, 1691, 1703};
int FLswing2[21] = {1777, 1797, 1814, 1830, 1842, 1852, 1858, 1861, 1861, 1858, 1854, 1849, 1845, 1843, 1843, 1850, 1863, 1885, 1920, 1968, 2034};
int FLswing3[21] = {1723, 1624, 1530, 1448, 1382, 1336, 1313, 1313, 1338, 1387, 1458, 1549, 1656, 1774, 1898, 2020, 2133, 2227, 2293, 2320, 2296};
int FLswing4[21] = {1867, 1830, 1822, 1838, 1872, 1922, 1983, 2051, 2122, 2193, 2260, 2320, 2369, 2405, 2424, 2424, 2401, 2354, 2279, 2174, 2038};

int HLswing1[21] = {2503, 2550, 2628, 2719, 2806, 2877, 2921, 2930, 2899, 2828, 2716, 2567, 2388, 2188, 1979, 1775, 1595, 1458, 1388, 1410, 1555};
int HLswing2[21] = {2039, 2075, 2101, 2117, 2122, 2115, 2099, 2073, 2039, 2000, 1959, 1920, 1885, 1860, 1849, 1859, 1895, 1965, 2075, 2234, 2450};
int HLswing3[21] = {1546, 1468, 1389, 1313, 1244, 1187, 1144, 1116, 1107, 1116, 1144, 1192, 1259, 1342, 1441, 1553, 1675, 1803, 1933, 2059, 2178};
int HLswing4[21] = {2311, 2566, 2731, 2823, 2859, 2853, 2817, 2762, 2698, 2633, 2574, 2526, 2491, 2472, 2468, 2479, 2502, 2531, 2562, 2586, 2594};
...
void receiveData(int HowMany){
  ...
  else if (indicator == 1)
  {
    ...
    if (inNum > 0){
      ...
      Serial.println("FinishedSending");
      indicator = 2;
      breakCondition = 1;
    }
  }
