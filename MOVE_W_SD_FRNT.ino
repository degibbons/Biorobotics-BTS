...
void setup() {
  ...
  while (!Serial) {
    ...
    dxlSetGoalPosition(3, 2048);
    dxlSetGoalPosition(4, 2048);
    dxlSetGoalPosition(5, 2048);
    dxlSetGoalPosition(6, 2048);
    dxlSetGoalPosition(7, 2048);
    dxlSetGoalPosition(8, 2048);
    delay(5000);
...
while(1){
  ...
  dxlSetGoalSpeed(1, 46);
  dxlSetGoalSpeed(2, 46);
  dxlSetGoalSpeed(3, 46);
  dxlSetGoalSpeed(4, 46);
  dxlSetGoalSpeed(5, 46);
  dxlSetGoalSpeed(6, 46);
  dxlSetGoalSpeed(7, 46);
  dxlSetGoalSpeed(8, 46);
  ...
  //Define all the variables utilzed in loop
    ...
    torq1 = dxlGetTorque(1);
    sped1 = dxlGetGoalSpeed(1);
    volt1 = dxlGetVoltage(1);
    temp1 = dxlGetTemperature(1);
    curr1 = mxGetCurrent(1);
    posi1 = dxlGetPosition(1);

    torq2 = dxlGetTorque(2);
    sped2 = dxlGetGoalSpeed(2);
    volt2 = dxlGetVoltage(2);
    temp2 = dxlGetTemperature(2);
    curr2 = mxGetCurrent(2);
    posi2 = dxlGetPosition(2);

    torq3 = dxlGetTorque(3);
    sped3 = dxlGetGoalSpeed(3);
    volt3 = dxlGetVoltage(3);
    temp3 = dxlGetTemperature(3);
    curr3 = mxGetCurrent(3);
    posi3 = dxlGetPosition(3);

    torq4 = dxlGetTorque(4);
    sped4 = dxlGetGoalSpeed(4);
    volt4 = dxlGetVoltage(4);
    temp4 = dxlGetTemperature(4);
    curr4 = mxGetCurrent(4);
    posi4 = dxlGetPosition(4);

    torq5 = dxlGetTorque(5);
    sped5 = dxlGetGoalSpeed(5);
    volt5 = dxlGetVoltage(5);
    temp5 = dxlGetTemperature(5);
    curr5 = mxGetCurrent(5);
    posi5 = dxlGetPosition(5);

    torq6 = dxlGetTorque(6);
    sped6 = dxlGetGoalSpeed(6);
    volt6 = dxlGetVoltage(6);
    temp6 = dxlGetTemperature(6);
    curr6 = mxGetCurrent(6);
    posi6 = dxlGetPosition(6);

    torq7 = dxlGetTorque(7);
    sped7 = dxlGetGoalSpeed(7);
    volt7 = dxlGetVoltage(7);
    temp7 = dxlGetTemperature(7);
    curr7 = mxGetCurrent(7);
    posi7 = dxlGetPosition(7);

    torq8 = dxlGetTorque(8);
    sped8 = dxlGetGoalSpeed(8);
    volt8 = dxlGetVoltage(8);
    temp8 = dxlGetTemperature(8);
    curr8 = mxGetCurrent(8);
    posi8 = dxlGetPosition(8);
    ...
    dxlSetGoalPosition(5, m1);
    dxlSetGoalPosition(6, m2);
    dxlSetGoalPosition(7, m3);
    dxlSetGoalPosition(8, m4);
